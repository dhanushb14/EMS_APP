...
class LeaveRequestViewTest(TestCase):
    def setUp(self):
        self.client = Client()
        self.factory = RequestFactory()
        self.leave_request_url = reverse('leave_detail')
        ...
        self.client.login(username='122111', password='12345')
    ...
    def test_leave_request_create(self):
        ...
        saved_leave_request = LeaveRequest.objects.get(pk=leave_request.pk)
        self.assertEqual(saved_leave_request.employee, self.employee)
        self.assertEqual(saved_leave_request.employee_name, self.employee.employee_name)
        self.assertEqual(saved_leave_request.leave_type, 'Sick leave')
        self.assertEqual(saved_leave_request.no_of_days, 1)
        self.assertEqual(saved_leave_request.description, 'Not feeling well')
        self.assertEqual(saved_leave_request.comments, 'No comments')
        self.assertEqual(saved_leave_request.status, 'Pending')
    ...
    def test_leave_request_approve(self):
        ...
        saved_leave_request = LeaveRequest.objects.get(pk=leave_request.pk)
        self.assertEqual(saved_leave_request.comments, 'Leave Request approved')
        self.assertEqual(saved_leave_request.status, 'Approve')
